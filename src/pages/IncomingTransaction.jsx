                    ...
                    return (
                      <>
                        <tr style={{ height: "60px" }} className="text-center">
                          ...
                          <td className={data.status === "active" ? "text-success" : data.status === "pending" ? "text-warning" : "text-danger"}>{data.status === "success" ? "Success" : data.status === "pending" ? "pending" : "Failed"}</td>
                        </tr>
                      </>
                    );
                  })}
